...
highest_peaks$description[nrow(highest_peaks)-1] <- paste(highest_peaks$name[nrow(highest_peaks)-2] , " at " , highest_peaks$elevationNum[nrow(highest_peaks)-2] , "m is the highest place in the UK")
