...
map  = mapview(s100000,  layer.name = "100km", col.regions = "yellow") +
    mapview(s50000,  layer.name = "50km", col.regions = "blue") +
    mapview(s20000, layer.name = "20km", col.regions = "green") +
  mapview(s10000, layer.name= "10km", col.regions = "red") 
